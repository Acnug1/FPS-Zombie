...
public class Shop : MonoBehaviour
{
    ...
    private void AddItem(Weapon weapon)
    {
        ...
        view.Render(weapon);
        view.name = _template.name + (_itemContainer.childCount); // к имени шаблона добавляем порядковый номер количества объектов в данный момент в контейнере content
    }
